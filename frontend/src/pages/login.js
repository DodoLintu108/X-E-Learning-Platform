...
export default function Login() {
  ...
  return (
    <div style={{ backgroundColor: "#FBFBFB", height: "100vh", display: "flex", flexDirection: "column" }}>
      <Navbar />
      <div style={{
        display: "flex",
        flexDirection: "row",
      ...
      <div style={{
        ...
        <h1 style={{ fontSize: "22px", fontWeight: "600",transition: "color 0.3s", 
            cursor: "pointer", }} 
        ...
        <p>Don't have an account? ... 
          <Link href="/register" style={{ color: "#024CAA", textDecoration: "none" }}>
            Start a new journey
          </Link>
        </p>      </div>
    </div>
